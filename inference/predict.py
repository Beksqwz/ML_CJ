...
def run(datetime_hour: str, output_dir: Path) -> dict:
    ...
    for h, model_rel, version in (
        ("1h", "models/stage7d/catboost_1h_weather_experiment.cbm", "Stage 7D"),
        ("24h", "models/stage7b/catboost_24h.cbm", "Stage 7B"),
    ):
        ...
        gp, jp = export(rows, h, output_dir, ROOT / "astana_edges.csv")
