...
def _row(**changes: object) -> dict[str, object]:
    row = {
        "road_segment_id": "1",
        "prediction_datetime": "2026-07-15T10:00:00+05:00",
        "dynamic_rank": 1,
        "dynamic_percentile": 0.995,
        "historical_hotspot_rank": 10,
        "historical_hotspot_percentile": 0.998,
    ...
    def test_degraded_low_signal_segment_is_monitor_only(self):
        result = recommend_stage20b(
            pd.DataFrame(
                [
                    _row(
                        dynamic_percentile=0.20,
                        historical_hotspot_rank=300,
                        historical_hotspot_percentile=0.20,
        ...
        result = recommend_stage20b(
            pd.DataFrame(
                [
                    _row(
                        road_segment_id="2",
                        dynamic_percentile=0.60,
                        historical_hotspot_rank=100,
                    ),
