"""Optional OpenWeather current-conditions integration for Astana."""
...
class OpenWeatherService:
    """Fetch current Astana weather and normalize it to production feature names."""
    ...
    def get_current(self) -> dict[str, Any]:
        """Return current conditions; missing keys and request failures are safe states."""
        ...
        try:
            ...
            temperature, humidity = float(main["temp"]), float(main["humidity"])
            return {
                "available": True,
